...
def getAllDataByDate(conn, start_date='20040601', end_date='20180101'):
    sql1 = 'SELECT code, TRADE_DT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R FROM additional_data_2 WHERE \
                     TRADE_DT>\'%s\' and TRADE_DT<\'%s\';' % (start_date, end_date)
    sql2 = 'SELECT code, TRADE_DT, A, A1, B, B1, C, E, E1, F, G_A, G_B, G_R, H_A, H_B, H_E, I1, I2, J1, J2, J3, J4, ' \
           'J5, J6, J7, J8 FROM additional_data_3 WHERE TRADE_DT>\'%s\' and TRADE_DT<\'%s\';' % (start_date, end_date)
    start_time = time.time()
    ...
    result2 = pd.read_sql(sql2, conn).rename(columns={'code': 'code', 'TRADE_DT': 'TRADE_DT',
                                                      'A': 'TopOverCurrent_20', 'A1': 'TopOverCurrent_125',
                                                      'B': 'TopDistance_20', 'B1': 'TopDistance_125',
                                                      'C': 'MA5_GT_MA20_10', 'E': 'Sqrt_Yield_over_Volume_Open',
                                                      'E1': 'Sqrt_Yield_over_Volume_Close',
                                                      'F': 'RootMTM_5', 'G_A': 'ACC_A_20', 'G_B': 'ACC_B_20',
                                                      'G_R': 'ACC_R_20',
                                                      'H_A': 'IV_A_20', 'H_B': 'IV_B_20', 'H_E': 'IV_E_20',
                                                      'I1': 'Z_SCORE', 'I2': 'Z_SCORE_FREE',
                                                      'J1': 'VROC_12', 'J2': 'VRSI_6', 'J3': 'VR_26',
                                                      'J4': 'VOLUME_RATIO_5',
                                                      'J5': 'VMACD_DIF_12', 'J6': 'VMACD_DEA_26', 'J7': 'VMACD_MACD_9',
                                                      'J8': 'VSTD_10'})
    duration = time.time() - start_time
    print 'done. {}s used.'.format(duration)
