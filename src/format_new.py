...
def extend(key, v):
    ...
    emv_15 = emv(v, 15)
    emv_26 = emv(v, 26)
    v += [emv_3, emv_5, emv_7, emv_10, emv_15, emv_26]
    ...
    cr_15 = cr(v, 15)
    cr_26 = cr(v, 26)
    v += [cr_3, cr_5, cr_7, cr_10, cr_15, cr_26]
    ...
    br_15 = br(v, 15)
    br_26 = br(v, 26)
    v += [br_3, br_5, br_7, br_10, br_15, br_26]
    ...
    v += [sma_3, sma_5, sma_7, sma_10, sma_15, sma_26]
    ...
    v += [ema_3, ema_5, ema_7, ema_10, ema_15, ema_26]
    
    macd_5 = macd(v, 5, 3, 2)
    macd_10 = macd(v, 10, 5, 3)
    macd_15 = macd(v, 15, 7, 5)
    macd_26 = macd(v, 26, 12, 9)
    v += [macd_5, macd_10, macd_15, macd_26]
    ...
    boll_15 = boll(v, 15);
    boll_26 = boll(v, 26);
    v += [boll_3, boll_5, boll_7, boll_10, boll_15, boll_26]
    ...
    rsi_15 = rsi(v, 15)
    rsi_26 = rsi(v, 26)
    v += [rsi_3, rsi_5, rsi_7, rsi_10, rsi_15, rsi_26]
    ...
    bias_15 = bias(v, 15)
    bias_26 = bias(v, 26)
    v += [bias_3, bias_5, bias_7, bias_10, bias_15, bias_26]
    ...
    cci_15 = cci(v, 15)
    cci_26 = cci(v, 26)
    v += [cci_3, cci_5, cci_7, cci_10, cci_15, cci_26]
    ...
    v += [mtm_4, mtma_4, mtm_8, mtma_8, mtm_12, mtma_12, mtm_20, mtma_20, mtm_26, mtma_26]
    ...
    osc_15 = osc(v, 15)
    osc_26 = osc(v, 26)
    v += [osc_3, osc_5, osc_7, osc_10, osc_15, osc_26]
    ...
    psy_15 = psy(v, 15)
    psy_26 = psy(v, 26)
    v += [psy_3, psy_5, psy_7, psy_10, psy_15, psy_26]
    ...
    wms_15 =  wms(v, 15)
    wms_26 =  wms(v, 26)
    v += [wms_3, wms_5, wms_7, wms_10, wms_15, wms_26]
    ...
    obv_15 = obv(v, 15)
    obv_26 = obv(v, 26)
    v += [obv_3, obv_5, obv_7, obv_10, obv_15, obv_26]
