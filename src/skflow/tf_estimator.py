...
class BaseEstimator(
    ...
    def fit(self, x=None, y=None, input_fn=None, steps=None, batch_size=None, monitors=None, max_steps=None):
        ...
        input_fn, feed_fn = _get_input_fn(
            x, y, input_fn, feed_fn=None, batch_size=batch_size, shuffle=True, epochs=None)
        
        loss = self._train_model(
            input_fn=input_fn, feed_fn=feed_fn, steps=steps, monitors=monitors, max_steps=max_steps)
    ...
    def evaluate(self, x=None, y=None, input_fn=None, feed_fn=None,
        ...
        eval_results, global_step = self._evaluate_model(
            input_fn=input_fn, feed_fn=feed_fn, steps=steps, metrics=metrics, name=name)
    ...
    def predict(self, x=None, input_fn=None, batch_size=None, outputs=None, as_iterable=False):
